...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<@jspEl 'ctx'/>/css/themes/default/easyui.css">
	<link type="text/css" rel="stylesheet" href="<@jspEl 'ctx'/>/css/themes/icon.css">
	<link type="text/css" rel="stylesheet" href="<@jspEl 'ctx'/>/css/default.css">
	<script type="text/javascript" src="<@jspEl 'ctx'/>/scripts/jquery.min.js"></script>
	<script type="text/javascript" src="<@jspEl 'ctx'/>/scripts/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="<@jspEl 'ctx'/>/scripts/locale/easyui-lang-zh_CN.js"></script>
</head>
<body>
		...
		<#list table.columns as column>
			...
			<tr>
				...
				<#if column.isDateTimeColumn>
					...
					<#else>
					<input  value="<@jspEl 'model.'+column.columnNameLower/>" id="${column.columnNameLower}" name="${column.columnNameLower}"
					type="text"  class="easyui-textbox"  readonly="readonly"  />
					</#if>
				</td>
			</tr>
